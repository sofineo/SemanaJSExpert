...
export default class HandGestureController {
  ...
  #scrollPage(direction) {
    ...
    if(this.#lastDirection.direction === direction) {
      this.#lastDirection.y = (
        direction === 'scroll-down' ? this.#lastDirection.y + pixelPerScroll : 
  ...
  this.#view.loop(this.#loop.bind(this)) //bind para garantir que o this não é da classe #view e sim da prórpia Controller
